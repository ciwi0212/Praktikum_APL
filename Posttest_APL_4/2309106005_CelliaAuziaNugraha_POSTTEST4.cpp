...
struct data_diri{
    ...
    void display(){
        ...
        if(jmlh > 0){
            ...
            for (int a=0; a<jmlh; a++){
                ...
                cout<<"Lokasi: "<<pengguna[a].loc.kota<<", "<<pengguna[a].loc.negara<<endl;
        }
    } else{
    ...
    void add(){
        ...
        if (jmlh < 10){
            ...
            cout<<"Masukkan Kota: ";
            getline(cin,pengguna[jmlh].loc.kota);
            cout<<"Masukkan Negara: ";
            getline(cin,pengguna[jmlh].loc.negara);
            jmlh++;
            display();
            cout<<"ulang? (y/t): ";
            cin>>ulang;
    ...
    void update(){
        ...
        getline(cin,pengguna[y-1].loc.kota);
        cout<<"Masukkan Negara Baru: ";
        getline(cin,pengguna[y-1].loc.negara);
        display();
        cout<<"Ubah Lagi? (y/t): ";
        cin>>ulang;
        if (ulang == 'y'){
